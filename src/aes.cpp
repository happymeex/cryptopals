...
int inv_sbox[256] = {
    ...
    166, 194, 35, 61, 238, 76, 149, 11, 66, 250, 195,
    ...
    184, 179, 69, 6, 208, 44, 30, 143, 202, 63, 15, 2, 193, 175, 189, 3,
    ...
    192, 254, 120, 205, 90, 244, 31, 221, 168, 51, 136, 7, 199, 49, 177,
    18, 16, 89, 39, 128, 236, 95, 96, 81, 127, 169, 25, 181, 74, 13, 45, 229,
    122, 159, 147, 201, 156, 239, 160, 224, 59, 77, 174, 42, 245, 176, 200, 235,
...
block inverseMixColumns(const block &b){
    ...
    for (int i = 0; i < 16; i++){
        int rem = i % 4;
        int val =  mul14[b.at(i)]
            ^mul9[b.at(i-1 + ((rem == 0) ? 4 : 0))]
