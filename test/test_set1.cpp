...
TEST_CASE("Set 1 challenge 1: hex to b64") {
    ...
    in >> s_in;
    expected >> s_out;
    byteseq::ByteSeq b = byteseq::ByteSeq{hex{s_in}};
...
TEST_CASE("Set 1 challenge 2: hex xor") {
    ...
    in >> s1 >> s2;
    byteseq::ByteSeq b1 = byteseq::ByteSeq{hex{s1}};
    byteseq::ByteSeq b2 = byteseq::ByteSeq{hex{s2}};
    expected >> s_out;
...
TEST_CASE("Set 1 challenge 3: single byte xor cipher") {
    ...
    auto [decrypted, _, key] =
        single_byte_xor_cipher(byteseq::ByteSeq{hex{s_in}});
